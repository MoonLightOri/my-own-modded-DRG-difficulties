As Interstellar is still a WIP difficulty, this feature list may be subject to change. This list is updated to b36 version.
...
- (new) StationaryDifficulty is adjusted base on biome (big biome room has reduced point).
