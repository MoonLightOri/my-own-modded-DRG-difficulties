As Interstellar is still a WIP difficulty, this feature list may be subject to change. This list is updated to b15 version.
...
- (new) Breeder type enemies (except for Battle Blimp which has opposite effect) have lowered Freeze temp.
...
- Sentinel
  - These are the bugs the Dreadnought Hiveguard summon. These also move 25% faster and have Fire damage and Electric weakness by 30%. 
- Leech
...
- *new* Carrier (CD2 - inspiration from DH difficulty)
  - This is an elite version of promoted type of grabber that has x2 damage taken and has s5 stalker's cloak material. Instead they move extremely fast. It's banned in Defensive objective, Drillevator, additionally in Encounter and as well as in 1 player count lobby.
- Bulk Detonator
...
- Elite Guard, Elite Grunt Slasher, Elite Mactera Spawn, *new* Elite Septic Spreader, Elite Stingtail and Elite Ratter (CD2 - DEA)
  ...
  - Elite Mactera Spawn gains x10.088 damage taken increase. They are also 10% slower time dialated.
...
- Every 60 seconds, either 15-20 Grunts with 1-4 White Spitters, 0-1 Bundle or/with 1-3 Mactera Spawns, or 2-3 Mini-Bulks spawn. Mini-Bulks from this WaveController are not allowed to spawn on Escort, and disabled while in caretaker fight. Minibulk wave has a slightly higher chance to spawn compare to FC. Enemy amount is adjusted for the playercount.
