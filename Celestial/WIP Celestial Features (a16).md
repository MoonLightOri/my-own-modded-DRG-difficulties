As Celestial is still a WIP difficulty, this feature list may be subject to change. This list is updated to a16 version.
...
- StationaryDifficulty is adjusted base on biome (big biome room has reduced point).
