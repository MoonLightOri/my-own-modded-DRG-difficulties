As Astral is still a WIP difficulty, this feature list may be subject to change. This list is updated to a11 version.
...
- Elimination: StationaryDifficulty is reduced on big biome room.
