As Astral is still a WIP difficulty, this feature list may be subject to change. This list is updated to a06 version.
...
- Sniper Turret
  - They have 50% less HP than normally.
- Korlok Sprouts (MEV)
...
- Barrier Spitter (CD2)
  ...
  At 1 Player Count MaxSpawnCount is reduced to 0.
- Crawler
...
- Every 100 seconds (170 seconds during Refinery Stalling/Repair phase), a 1-2 weak Elite Slashers spawns in. This wavespawner is banned in 1p setting.
