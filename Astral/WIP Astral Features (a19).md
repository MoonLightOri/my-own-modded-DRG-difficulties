As Astral is still a WIP difficulty, this feature list may be subject to change. This list is updated to a19 version.
...
- Recommended Mods: 
  ...
  + Sabo with Stationaries & More Egg Swarms (Use MINT to Install): https://drive.google.com/file/d/1-FPzfrHX7dozcD3BQX5VWSovlQ4jfwTR/view?usp=sharing
...
- Lower player scaling will have some change (both Enemies and Objectives) to make playing easier. (E.G: Doretta during Refill and Heartstone phase gains slight increased resistance. No Bulk spawns during Defense, ...)
...
- Nexus
  ...
  + They now instead spawn white normal Grunt that only have 70 HP.
- Grabber
...
- Stalker (Beta Stalkers from MEV)
  ...
  + Set your Effects in the in-game options to High to see them while they are cloaked.
...
- Glyphid Architect (CD2)
  + It is a rare menace that has Base HP x0.7855 and Time Dilation -25%. Its material is changed also.
...
- Korlok Sprouts (MEV)
  + Sprouts spawn as Stationaries similar to Nexuses, Leeches, Breeders, and Spitballers. They can spawn only on the ground and start off sleeping until they take damage.
  + Base HP -1/6. Its material is slightly changed to shine in the dark.
- Spitscreener (CD2, MEV)
  + They are more expensive Spitballer that have Time Dilation -1/3. Their material is changed also.
...
- During Dreadnought or Caretaker fight, Normal Wave will spawn in periodically. In Dreadnought fight the Interval is increased by 50, but the beginning of the fight will guarantee a Normal Wave.
